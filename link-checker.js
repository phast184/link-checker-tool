...
const argv = yargs
  ...
  .describe(
    "t",
    "To check 10 latest posts from telescope using local url http://localhost:3000/posts"
  )
  .example(
    "lct --ar https://www.google.com/",
    "Check the archived versions of https://www.google.com/"
  )
  .example(
    "lct -u https://www.google.com/",
    "Check the status of https://www.google.com/"
  )
  .example(
    "lct -i ignore-urls.txt -f test.txt",
    "Report about all URLS except the URLS mentioned in ignore-urls.txt"
  )
  .help("help")
